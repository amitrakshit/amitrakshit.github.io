...
for (let i = 0; i < 4; i++) {
    ...
    balance_column[i] = table_data[4*i + 3];
}
...
if (check_1.classList[1] == "right" && check_2.classList[1] == "right" && check_3.classList[1] == "right")
    {   
        if (reactant_1.multiplier == 2 && reactant_2.multiplier == 3)
            {
