...
// Data collection for user response
var data = {
...
// MSQ instruction
var MSQinstruction = document.querySelector('#MSQinstruction');
...
function submitAns() {
    Object.assign(MSQinstruction.style, { opacity: 0 }); // removing the MSQ instruction
    ...
    if (rightAnswerStatus == true && wrongAnswerStatus == false && userRespondedAllOptions == false) {
        ...
        data.correctResponse = "partially correct";
        data.response = userResponse;
    }
        ...
        // user response collece
        data.correctResponse = "wrong";
        data.response = userResponse;
    }
        ...
        data.correctResponse = "user had chosen all options";
        data.response = userResponse;
    }
