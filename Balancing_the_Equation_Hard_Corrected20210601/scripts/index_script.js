...
{ sound.play();
    sound.playbackRate = 3;
    highlight3.style.background = "#28334F";
    highlight2.style.background = "linear-gradient(180deg, #FEAFC6 0%, #FA65A7 100%)";
...
function reset_instruction()
 ...
 { 
    ...
    document.getElementsByClassName("equation_container")[0].style.top = "1434px";
    document.getElementsByClassName("equation_container")[0].style.transition = " top 0.5s";
    document.getElementsByClassName("next_button")[0].style.top = "1704px";
    document.getElementsByClassName("next_button")[0].style.transition = " top 0.5s";
    document.getElementsByClassName("reset_button")[0].style.top = "100%";
    document.getElementsByClassName("next_button")[0].style.innerText = "Button";
    // highlight1.style.backgroundColor = "#4D5A7E";
    // h1.style.backgroundColor = "#3E4865";
    btn1.style.display = "inline"; btn2.style.display = "inline";
    btn3.style.display = "inline"; btn4.style.display = "inline";
    btn5.style.display = "inline"; btn6.style.display = "inline";
    btn7.style.display = "inline"; btn8.style.display = "inline";
