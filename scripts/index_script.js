...
// insideDiv.innerHTML = 'This is inside';
...
imageArray[0].style = 'position:absolute; left:0px; top:-18px; width: 100%;';
imageArray[1].style = 'position:absolute; left:0px; top:-18px; width: 100%;';
imageArray[2].style = 'position:absolute; left:0px; top:-18px; width: 100%;';
imageArray[3].style = 'position:absolute; left:0px; top:-18px; width: 100%;';
// feedbackArea.appendChild(insideDiv);
...
NextButton.onclick = function () {
    ...
    if (NextButtonClickTimes == 1) {
        ...
        setTimeout(() => {
            ...
            feedbackArea.appendChild(imageArray[3]);
            feedbackArea.style = "opacity:1; top: 58.3%;";
        }, 500);
